...
#define BLYNK_TEMPLATE_ID "TMPL3gG79DWON"
#define BLYNK_TEMPLATE_NAME "Home automation1"
#define BLYNK_AUTH_TOKEN "PY-Cfbr51NZcJLW1yEwNZ6lLzHyuNHpY"
...
void handle_temp(void)
{
  if((read_temperature() >float(35)) && heater_sw){
   ...
   lcd.setCursor(7,0);
  lcd.print("HT_LR OFF");
  Blynk.virtualWrite(BLYNK_TERMINAL_V_PIN,"Temperature is above 35 degres celsius\n");
...
void handle_tank(void)
{
  ...
  Blynk.virtualWrite(BLYNK_TERMINAL_V_PIN,"Turing Off the inlet valve\n");
